...
from .const import (
    ...
    PROP_LR_ANGLE, PROP_ROTATE, PROP_TIMER_ACTION, PROP_TIMER_HOUR,
    PROP_TIMER_MINUTE, PROP_TIMER_ON, TIMER_ACTION_TURN_OFF, TIMER_MAX,
    TIMER_MIN,
)
...
class GreeFanEntity(CoordinatorEntity[DeviceDataUpdateCoordinator], FanEntity):
    ...
    async def async_added_to_hass(self) -> None:
        ...
        native_minutes = self._native_timer_minutes(properties)
        if native_minutes > 0:
        ...
        elif not native_timer_available:
